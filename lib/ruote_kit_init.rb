...
RuoteKit.engine.configure('ruby_eval_allowed', true)

#RuoteKit.engine.add_service(
...
require File.expand_path('../../app/models/workitem.rb', __FILE__)

RuoteKit.engine.participant_list = []

RailsBpm.register_participants
